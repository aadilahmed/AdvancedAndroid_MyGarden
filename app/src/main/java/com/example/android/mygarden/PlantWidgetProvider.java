...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setImageViewResource(R.id.widget_plant_image, image);
    ...
    public static void updatePlantWidgets(Context context, AppWidgetManager appWidgetManager, int image, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            updateAppWidget(context, appWidgetManager, image, appWidgetId);
        }
    }
